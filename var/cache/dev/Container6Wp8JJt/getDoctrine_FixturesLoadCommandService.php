...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ProductImageFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\CategoryFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ProductFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ProductImageFixtures(), 'groups' => []]]);
